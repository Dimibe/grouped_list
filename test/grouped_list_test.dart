...
void main() {
  ...
  Widget buildAppWithInterdependency(List elements, {
    bool reverse = false,
  ...
  testWidgets('Finds previous, current and next expected elements using interdependency builder',
    ...
    await widgetTester.pumpWidget(buildAppWithInterdependency(
        _elements.sublist(0,0)
    ));
